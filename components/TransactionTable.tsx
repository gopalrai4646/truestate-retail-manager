...
const TransactionTable: React.FC<TransactionTableProps> = ({ data, sort, onSortChange }) => {
  ...
  if (data.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-96 text-gray-500 bg-white border border-gray-200 rounded-lg m-4">
